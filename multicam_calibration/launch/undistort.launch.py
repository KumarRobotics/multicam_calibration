...
#
# example launch file for undistort node
#
...
def generate_launch_description():
    """Launch undistort component."""
    container = ComposableNodeContainer(
            name='undistort_container',
            namespace='',
            ...
            composable_node_descriptions=[
                ComposableNode(
                    ...
                    plugin='multicam_calibration::UndistortComponent',
    ...
    name_arg = LaunchArg('node_name', default_value=['undistort'],
